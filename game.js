...
function update() {
  ...
  if (!phantomMode) {
    ...
    const interval = Math.max(20, Math.round(baseInterval * (1 + mods0.spawnIntervalMult) / Math.pow(2.0, enemyBoostStacks)));
    spawnTimer++;
